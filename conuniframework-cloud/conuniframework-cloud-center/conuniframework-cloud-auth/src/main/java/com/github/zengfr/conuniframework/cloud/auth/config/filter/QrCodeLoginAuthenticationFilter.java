 ...
 *
 * <p>二维码登陆： post: /qrLogin?qrCode=token 生成二维码，建立 websocket - 后台 用户在移动端扫码，回调事件到后台
 * 后台通过websocket通知前台登陆 前台post:/qrLogin, qrCode为生成二维码时后台生成的key
 */
public class QrCodeLoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
  ...
  public Authentication attemptAuthentication(
    ...
    String principal;
    String credentials;
    String params = obtainParameter(request, "params");
    // 二维码
